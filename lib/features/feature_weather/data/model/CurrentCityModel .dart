...
const CurrentCityModel ({
  ...
  this.base , 
  this.main , 
  this.visibility , this.wind , 
  this.rain , this.clouds , this.dt , 
  this.sys , this.timezone , this.id ,
   this.name , this.cod }) : super(coord, weather, base, main, visibility, wind,rain , clouds, dt, sys, timezone, id, name, cod);
...
Map<String,Object?> toJson(){
    return {
            'coord': coord?.toJson(),
'weather': weather?.map<Map<String,dynamic>>((data)=> data.toJson()).toList(),
'base': base,
'main': main?.toJson(),
...
static CurrentCityModel  fromJson(Map<String , Object?> json){
    return CurrentCityModel (
            coord:json['coord'] == null ? null : Coord.fromJson(json['coord']  as Map<String,Object?>),
weather:json['weather'] == null ? null : (json['weather'] as List).map<Weather>((data)=> Weather.fromJson(data  as Map<String,Object?>)).toList(),
base:json['base'] == null ? null : json['base'] as String,
main:json['main'] == null ? null : Main.fromJson(json['main']  as Map<String,Object?>),
visibility:json['visibility'] == null ? null : json['visibility'] as int,
wind:json['wind'] == null ? null : Wind.fromJson(json['wind']  as Map<String,Object?>),
rain:json['rain'] == null ? null : Rain.fromJson(json['rain']  as Map<String,Object?>),
clouds:json['clouds'] == null ? null : Clouds.fromJson(json['clouds']  as Map<String,Object?>),
dt:json['dt'] == null ? null : json['dt'] as int,
sys:json['sys'] == null ? null : Sys.fromJson(json['sys']  as Map<String,Object?>),
...
Sys copyWith({int? type, int? id, String? country, int? sunrise, int? sunset}){
return Sys(
            type:type ?? this.type,
id:id ?? this.id,
...
static Clouds fromJson(Map<String , Object?> json){
    return Clouds(
            all:json['all'] == null ? null : json['all'] as int
    );
}
...
static Rain fromJson(Map<String , Object?> json){
    return Rain(
            h:json['h'] == null ? null : json['h'] as double
    );
}
...
Main copyWith({double? temp, double? feelsLike, double? tempMin, double? tempMax, int? pressure, int? humidity, int? seaLevel, int? grndLevel}){
return Main(
            temp:temp ?? this.temp,
...
feelsLike:json['feelsLike'] == null ? null : json['feelsLike'] as double,
tempMin:json['tempMin'] == null ? null : json['tempMin'] as double,
tempMax:json['tempMax'] == null ? null : json['tempMax'] as double,
pressure:json['pressure'] == null ? null : json['pressure'] as int,
humidity:json['humidity'] == null ? null : json['humidity'] as int,
seaLevel:json['seaLevel'] == null ? null : json['seaLevel'] as int,
grndLevel:json['grndLevel'] == null ? null : json['grndLevel'] as int
    );
}
